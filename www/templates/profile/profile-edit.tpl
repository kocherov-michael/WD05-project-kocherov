					...
					<div class="row edit-user-profile-form__row">
						<div class="col-md-4">
							<label class="label">Имя
								<input class="input-text" type="text" placeholder="Введите имя" name="name" value=
								"<?=(isset($postName)) ? $postName : $currentUser->name ?>"/>
							</label>
						</div>
					</div>
					<div class="row edit-user-profile-form__row">
						<div class="col-md-4">
							<label class="label">Фамилия
								<input class="input-text" type="text" placeholder="Введите фамилию" name="secondname" value=
								"<?=(isset($postSecondname)) ? $postSecondname : $currentUser->secondname ?>"/>
							</label>
						</div>
					</div>
					<div class="row edit-user-profile-form__row">
						<div class="col-md-4">
							<label class="label">Email
								<input class="input-text" type="email" placeholder="Введите email" name="email" value=
								"<?=(isset($postEmail)) ? $postEmail : $currentUser->email ?>"/>
							</label>
						</div>
					</div>
					<div class="row edit-user-profile-form__row">
					...
					<div class="row edit-user-profile-form__row">
						<div class="col-md-4">
							<label class="label">Страна
								<input class="input-text" type="text" placeholder="Введите страну" name="country" value=
								"<?=(isset($postCountry)) ? $postCountry : $currentUser->country ?>"/>
							</label>
						</div>
					</div>
					<div class="row edit-user-profile-form__row">
						<div class="col-md-4">
							<label class="label">Город
								<input class="input-text" type="text" placeholder="Введите город" name="city" value=
								"<?=(isset($postCity)) ?  $postCity : $currentUser->city ?>"/>
							</label>
						</div>
					</div>
					<div class="row edit-user-profile-form__row">
